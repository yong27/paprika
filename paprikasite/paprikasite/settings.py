# Django settings for paprikasite project.
...
SECRET_KEY = '%x#dd!lc=kkdv)egvqqp!b@0b7tn=3%j=4t+w1jzm$1jubjb^5'
...
ROOT_URLCONF = 'paprikasite.urls'

# Python dotted path to the WSGI application used by Django's runserver.
WSGI_APPLICATION = 'paprikasite.wsgi.application'
